...
export function Carousel({ isVirtualized = false, ...props }: CarouselProps) {
  ...
  function getSlides() {
    ...
    const slides =
      carousel.querySelectorAll<HTMLElement>(`.${styles["carousel__slide"]}`) ||
      [];
  ...
  function nextSlide() {
    ...
    const position = firstNotVisibleSlide
      ? firstNotVisibleSlide.offsetLeft - offset
      : 0;
  ...
  function previousSlide() {
    ...
    if (!firstNotVisibleSlide) {
      const previousSlide = firstVisibleSlide.previousElementSibling as
        | HTMLElement
        | undefined;
    ...
    const position =
      slider.scrollLeft -
      (firstNotVisibleSlide.offsetLeft - firstVisibleSlide.offsetLeft);
      ...
      {isVirtualizedlist(isVirtualized, props) ? (
        <List
          ...
          className={classNames(
            styles.carousel__slider,
            styles["carousel__slider--virtualized"]
          )}
        >
